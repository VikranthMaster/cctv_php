...
if($int_hour!="00"){
    echo "<div style='float: left'><a href='./video_preview.php?camera=$CAMERA&date=$DATE&hour=$prev_hour'> Previous</a> (18hour)</div>";
}
if($int_hour!="23"){
    echo "<div style='float: right'><a href='./video_preview.php?camera=$CAMERA&date=$DATE&hour=$next_hour'> Next</a> (20hour)</div>";
}
